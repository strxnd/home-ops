...
This server is independent from the `minecraft` vanilla hardcore server. It
...
| --- | --- | --- |
| Paper | 26.1.2 build 61 | Server runtime |
| Java | Temurin 25 | JVM runtime |
...
3. Confirm Paper reports `26.1.2` build 61 and Java reports version 25.
